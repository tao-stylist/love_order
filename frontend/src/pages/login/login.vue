  ...
  <view class="page-login">
    ...
    <view class="login-content">
      ...
      <view class="login-form">
        <!-- 微信登录 -->
        <view v-if="loginType === 'wechat'" class="login-actions">
...
import { wxLogin, phoneLogin } from '../../utils/auth.js'
...
async function handlePhoneLogin() {
  ...
  try {
    ...
    const res = await phoneLogin(phoneForm.value.phone, phoneForm.value.nickname || selectedRole.value === 'boyfriend' ? '暖男' : '甜心')
